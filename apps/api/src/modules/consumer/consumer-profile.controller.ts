...
export class ConsumerProfileController {
  ...
  @ApiResponse({ status: 200, description: 'Consumer profile', type: ProfileResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Updated consumer profile', type: ProfileResponseDto })
