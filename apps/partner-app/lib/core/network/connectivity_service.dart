...
///
/// The partner app watches this to decide whether to sync the
/// [OfflinePickupQueue] immediately or defer to the next connectivity window.
///
/// ```dart
